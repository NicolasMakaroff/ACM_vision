...
from utils.loss import ACMLoss, DiceLoss, HDDTBinaryLoss
...
class UNet(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        self.log('haussdorf', hdd, prog_bar=False, on_step=False, on_epoch=True, logger=True)
